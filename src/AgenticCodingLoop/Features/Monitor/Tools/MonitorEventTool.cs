...
internal sealed class MonitorEventTool(string agentName, ConsoleColor color)
{
    ...
    public string ReportKeyEvent(
        [Description("Short event type such as found-implementation-work, found-review-work, at-capacity, or idle.")] string eventType,
