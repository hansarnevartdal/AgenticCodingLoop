...
internal sealed class ImplementerEventTool(string agentName, ConsoleColor color)
{
    ...
    public string ReportKeyEvent(
        [Description("Short event type such as picked-issue, opened-pr, requested-changes, approved, merged, or idle.")] string eventType,
